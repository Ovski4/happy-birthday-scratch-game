var configuration = {
    games: [
        ...
        },
        {
            ...
            backgroundImagePath: "images/light-blue-opacity.png",
            message: "C'est dommage,<br> vous aviez presque gagné <br>un radiateur pour avoir le cul moins gelé!"
        },
        {
        ...
        },
        {
            ...
            message: "" +
                "Félicitations!! " +
                "Vous êtes l'heureuse gagnante d\'un séjour d'un weekend pour deux personnes à disneyland" +
                "<br> <img src='images/leo.gif'>" +
            ""
        }
    ]
};